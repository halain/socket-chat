/**
 * Para renderizar el html del chat
 */

//query params, parametros de la url
...
/**
 * 
 * @param { [{persona1}, {persona2}] } personas  
 */
...
//cualquier click que se de en un <a> </a> dentro del divUsuarios,
divUsuarios.on('click', 'a', function(){

    var id = $(this).data('id'); // <a data-id="
...
formEnviar.on('submit', (e) => {
    ...
    socket.emit('crearMensaje', { nombre,  mensaje: txtMensaje.val() }, (mensaje)=> {
